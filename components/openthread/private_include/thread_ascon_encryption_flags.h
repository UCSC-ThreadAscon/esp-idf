...
#define ASCON_128_MAC_HEX_DUMP (CONFIG_THREAD_ASCON_HEX_DUMP == 1)
#define ASCON_128_MLE_HEX_DUMP (CONFIG_THREAD_ASCON_HEX_DUMP == 2)
#define ASCON_128A_MAC_HEX_DUMP (CONFIG_THREAD_ASCON_HEX_DUMP == 3)
#define ASCON_128A_MLE_HEX_DUMP (CONFIG_THREAD_ASCON_HEX_DUMP == 4)
